  ...
  return (
    <div className="container" style={{ padding: '80px 16px', maxWidth: '800px' }}>
      ...
      <div className="legal-content" style={{ display: 'flex', flexDirection: 'column', gap: '24px', lineHeight: '1.7', fontSize: '15px', color: 'var(--text-dark)' }}>
        ...
        <section>
          <h2 style={{ fontSize: '20px', fontWeight: 700, marginBottom: '12px', fontFamily: 'var(--font-heading)' }}>3. Sponsored Content Locker Verification</h2>
          <p>
            Our "Unlock Free" option leverages third-party sponsored tasks (e.g. installing featured apps, completing surveys). We do not control these third-party tasks or their availability. Upon successful verification of task completion by our network provider (AdBlueMedia), you will be granted access to download the cookbook.
          </p>
        </section>

        <section>
          <h2 style={{ fontSize: '20px', fontWeight: 700, marginBottom: '12px', fontFamily: 'var(--font-heading)' }}>4. Intellectual Property</h2>
          <p>
        ...
        <section>
          <h2 style={{ fontSize: '20px', fontWeight: 700, marginBottom: '12px', fontFamily: 'var(--font-heading)' }}>5. Health and Nutrition Disclaimer</h2>
          <p>
